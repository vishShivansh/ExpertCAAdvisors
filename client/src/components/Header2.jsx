...
export const Header2 = () => {
  ...
  return (
    ...
    >
      <div className="flex 2sm:hidden space-x-4">
        <Link to={"/"} className="text-blue-500">
          Home
        </Link>
        ...
        <button className="hidden 2sm:text-black" onClick={toggleMenu}>
          <Bars3Icon className="2sm:w-6 2sm:h-6" />
        </button>
      </div>
      {isMenuOpen && (
        <div className="hidden 2sm:mt-4 2sm:space-y-2">
          <Link to={"/AboutUs.aspx"} className="2sm:block 2sm:text-blue-500">
            About Us
          </Link>
          <Link to={"/Newsfeed.aspx"} className="2sm:block 2sm:text-blue-500">
            NewsFeed
          </Link>
